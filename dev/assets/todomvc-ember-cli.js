...
define('todomvc-ember-cli/tests/1-unit/controllers/todo-test', ['ember', 'ember-qunit', 'todomvc-ember-cli/tests/fixtures/todo'], function (Ember, ember_qunit, FIXTURES) {

  'use strict';

  function mockModel(data) {
    return Ember['default'].ObjectProxy.create(Ember['default'].merge(data, {
      saved: false,
      save: function() {
        this.set('saved', true);
      },
  ...
  ember_qunit.test('acceptChanges with a title', function() {
    ...
    var controller = this.subject();
    Ember['default'].run(function() {
      var model = mockModel(FIXTURES['default'][0]);
...
define('todomvc-ember-cli/tests/1-unit/controllers/todos-test', ['ember', 'ember-qunit', 'todomvc-ember-cli/tests/fixtures/todo'], function (Ember, ember_qunit, FIXTURES) {
  ...
  ember_qunit.test('remaining', function () {
    expect(2);
    var controller = this.subject();
    var models = mockModel(FIXTURES['default']);
...
if (runningTests) {
  ...
  require("todomvc-ember-cli/app")["default"].create({"LOG_ACTIVE_GENERATION":true,"LOG_VIEW_LOOKUPS":true,"name":"todomvc-ember-cli","version":"DETACHED_HEAD.e188a5cf"});
}
